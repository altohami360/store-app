    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center text-sm">
            <div class="flex items-center gap-4">
                <a href="mailto:{{ __('storefront.support_email') }}" class="hover:text-blue-400 transition-colors flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                    {{ __('storefront.support_email') }}
                </a>
            ...
            <div class="flex items-center gap-4">
                ...
                <form action="{{ route('language.switch') }}" method="POST" class="inline">
                    ...
                    <button type="submit" class="hover:text-blue-400 transition-colors flex items-center gap-2">
                        ...
                        {{ app()->getLocale() === 'en' ? __('storefront.arabic') : __('storefront.english') }}
                    </button>
                </form>
            </div>
        </div>
