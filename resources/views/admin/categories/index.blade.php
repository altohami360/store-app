...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <h2 class="text-2xl font-bold text-gray-900">{{ __('admin.categories') }}</h2>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="{{ route('admin.categories.destroy', $category) }}"
                                          method="POST"
                                          class="inline"
                                          onsubmit="return confirm('{{ __('admin.confirm_delete', ['resource' => __('admin.category')]) }}')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
