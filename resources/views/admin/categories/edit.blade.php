        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="description[en]"
                          id="description_en"
                          rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent @error('description.en') border-red-500 @enderror">{{ old('description.en', $category->getTranslation('description', 'en')) }}</textarea>
            ...
            <div>
                ...
                <textarea name="description[ar]"
                          ...
                          rows="3"
                          dir="rtl"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent @error('description.ar') border-red-500 @enderror">{{ old('description.ar', $category->getTranslation('description', 'ar')) }}</textarea>
            ...
            @if($category->image)
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('admin.image') }} ({{ __('admin.current_image') }})
                    </label>
            ...
            <div>
                <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ $category->image ? __('admin.change_image') : __('admin.image') }}
                </label>
                <input type="file"
                       name="image"
                       id="image"
