        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="description[en]"
                          id="description_en"
                          rows="4"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent @error('description.en') border-red-500 @enderror">{{ old('description.en', $product->getTranslation('description', 'en')) }}</textarea>
            ...
            <div>
                ...
                <textarea name="description[ar]"
                          ...
                          rows="4"
                          dir="rtl"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent @error('description.ar') border-red-500 @enderror">{{ old('description.ar', $product->getTranslation('description', 'ar')) }}</textarea>
            ...
            @if($product->featured_image)
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('admin.featured_image') }} ({{ __('admin.current_image') }})
                    </label>
            ...
            <div>
                <label for="featured_image" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ $product->featured_image ? __('admin.change_image') : __('admin.featured_image') }}
                </label>
                <input type="file"
                       name="featured_image"
                       id="featured_image"
