...
<div class="max-w-4xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form action="{{ route('admin.pages.update', $page) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <textarea name="content[en]"
                          ...
                          rows="10"
                          required
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent @error('content.en') border-red-500 @enderror">{{ old('content.en', $page->getTranslation('content', 'en')) }}</textarea>
                @error('content.en')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea name="content[ar]"
                          ...
                          required
                          dir="rtl"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent @error('content.ar') border-red-500 @enderror">{{ old('content.ar', $page->getTranslation('content', 'ar')) }}</textarea>
                @error('content.ar')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea name="meta_description[en]"
                          ...
                          rows="2"
                          maxlength="500"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent @error('meta_description.en') border-red-500 @enderror">{{ old('meta_description.en', $page->getTranslation('meta_description', 'en')) }}</textarea>
            ...
            <div>
                ...
                <textarea name="meta_description[ar]"
                          ...
                          maxlength="500"
                          dir="rtl"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent @error('meta_description.ar') border-red-500 @enderror">{{ old('meta_description.ar', $page->getTranslation('meta_description', 'ar')) }}</textarea>
